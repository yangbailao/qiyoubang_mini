Component({
  ...
  methods: {
    setStyle: function(life) {
      ...
      // console.log(navBarHeight + navBarExtendHeight);
      let navBarLeft = [];
    ...
    back: function() {
      ...
      //   });
      // }
      // console.log(this.triggerEvent('back', { delta: this.data.delta }))
    ...
    getSystemInfo() {
      ...
      if (app.globalSystemInfo && !app.globalSystemInfo.ios) {
        ...
        //计算除了导航栏和tabbar之外的rpx高度
        let rpxR = 750 / systemInfo.windowWidth;

        systemInfo.contentHeight = systemInfo.windowHeight * rpxR - systemInfo.navBarExtendHeight * rpxR - systemInfo.navBarHeight * rpxR - 112;
